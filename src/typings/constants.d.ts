...
export type IconPresetType = "group" | "check" | "document" | "meeting" | "event" | "project" | "business" | "study" | "security" | "star" | "idea" | "heart" | "magcup" | "beer" | "music" | "sports" | "travel";
export interface Me {
    account_id: number;
    room_id: number;
    name: string;
...
export declare const CHATWORK_TOKEN = "X-ChatWorkToken";
export declare const BASE_URI = "https://api.chatwork.com/v2/";
export declare const STATUS_CODE: {
    readonly "200_OK": 200;
    readonly "204_NO_CONTENT": 204;
    readonly "300_MULTIPLE_CHOICES": 300;
    readonly "400_BAD_REQUEST": 400;
    readonly "401_UNAUTHORIZED": 401;
    readonly "403_FORBIDDEN": 403;
    readonly "404_NOT_FOUND": 404;
    readonly "429_TOO_MANY_REQUESTS": 429;
};
export {};
